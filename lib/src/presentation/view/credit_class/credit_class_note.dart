...
class CreditClassNoteView extends StatefulWidget {
  const CreditClassNoteView({super.key, required this.title, required this.id});
  final String title;
  final String id;
  @override
  State<CreditClassNoteView> createState() => _CreditClassNoteViewState();
}

class _CreditClassNoteViewState extends State<CreditClassNoteView> {
  TextEditingController controller = TextEditingController();
  @override
  void initState() {
    context
        .read<CreditClassBloc>()
        .add(GetCreditClassNoteEvent(classId: widget.id));
    super.initState();
  }
      ...
      body: SizedBox(
          ...
          child: SingleChildScrollView(
            child: Padding(
              ...
              child: BlocConsumer<CreditClassBloc, CreditClassState>(
